...
contract LiquidityExamples is IERC721Receiver {
    ...
    // note: Mỗi NFT được xác định bằng một ID uint256 duy nhất bên trong hợp đồng thông minh ERC-721, được khai báo là tokenId
    struct Deposit {
        address owner;
        uint128 liquidity;
        address token0;
    ...
    function mintNewPosition() external returns (uint _tokenId, uint128 liquidity, uint amount0, uint amount1) {
        ...
        INonfungiblePositionManager.MintParams memory params = INonfungiblePositionManager.MintParams({
            ...
            token1: USDC,
            fee: poolFee,
            //Bằng cách sử dụng TickMath.MIN_TICK và TickMath.MAX_TICK,
            //chúng tôi đang cung cấp tính thanh khoản trên toàn bộ phạm vi của nhóm
        ...
        //  chúng tôi có thể lấy mọi thanh khoản còn sót lại từ quá trình đúc tiền và hoàn trả vào msg.sender.
    ...
    // Chức năng này thu tất cả các khoản phí, gửi chúng cho chủ sở hữu ban đầu của NFT,
    // đồng thời duy trì quyền giám sát vị thế NFT.
    ...
    // Chức năng trợ giúp nội bộ này gửi bất kỳ mã thông báo nào,
    // dưới dạng phí hoặc mã thông báo vị trí, cho chủ sở hữu NFT.
