...
// ERC721 là một tiêu chuẩn để thể hiện quyền sở hữu các mã thông báo không thể thay thế
// Nghĩa là mỗi mã thông báo là duy nhất .
// Theo dõi các vật phẩm trong trò chơi của mình, mỗi vật phẩm sẽ có thuộc tính riêng
// Để hạn chế những tài khoản nào có thể đúc vật phẩm chúng ta có thể thêm Kiểm soát truy cập .

contract NFTPEPEMarketplace is ERC721URIStorage {
    ...
    uint256 listingPrice = 0.015 * 10 ** 18; //Đây là mức giá đặt danh sách (listing price) cho mỗi mục trong marketplace, được định dạng dưới dạng Ether.
    ...
    constructor() ERC721("PEPEATSCHOOL", "PAS") {
    ...
    function createToken(string memory tokenURI, uint256 price) public payable returns (uint256) {
        ...
        // chúng tôi sử dụng nó để lưu trữ siêu dữ liệu của một mục.
