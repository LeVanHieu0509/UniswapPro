  ...
  const navList = (
    <ul className="mt-2 mb-4 flex flex-col gap-2 lg:mb-0 lg:mt-0 lg:flex-row lg:items-center lg:gap-6">
      ...
      >
        ...
        <a href="tokens" className="flex items-center">
          Tokens
        </a>
      </Typography>
      <Typography
      ...
      >
        ...
        <a href="pools" className="flex items-center">
          Pools
        </a>
      </Typography>
    </ul>
  ...
  return (
    <Navbar placeholder className="mx-auto max-w-screen-xl px-4 py-2 lg:px-8 lg:py-4">
      <div className="container mx-auto flex flex-wrap items-center justify-between text-blue-gray-900">
        <Typography variant="h5" placeholder="" as="a" href="/" className="mr-4 cursor-pointer py-1.5 font-medium">
          UniswapPro
        </Typography>
      ...
      <MobileNav open={openNav}>
        <div className="container mx-auto">
          ...
          <div className="flex flex-col gap-x-2 sm:flex-row sm:items-center">
            ...
            <Button placeholder size="md" className="mt-1 rounded-lg sm:mt-0">
              Search
            </Button>
          </div>
        </div>
